...
# --- patterns/2-multi_account/terraform/spoke/variables.tf ---
...
# AWS RAM resource share (default not provided)
variable "resource_share_arn" {
  type        = string
  description = "AWS RAM resource share (from Networking Account)."
}

<!-- BEGIN_TF_DOCS -->
# AWS Cloud WAN East-West Inspection - Dual-Hop (Terraform)

![East-West Dual-Hop](../../../../images/east\_west\_dualhop.png)
...
cd patterns/3-traffic_inspection/3-east_west_dualhop/terraform
...
3. **Compare with single-hop**: Deploy [Pattern 4](../../4-east\_west\_singlehop/) to see the difference

...
| <a name="provider_aws.awsireland"></a> [aws.awsireland](#provider_aws.awsireland) | 6.7.0 |
| <a name="provider_aws.awsnvirginia"></a> [aws.awsnvirginia](#provider_aws.awsnvirginia) | 6.7.0 |
| <a name="provider_aws.awsoregon"></a> [aws.awsoregon](#provider_aws.awsoregon) | 6.7.0 |
...
| <a name="input_identifier"></a> [identifier](#input_identifier) | Project Identifier, used as identifer when creating resources. | `string` | `"outbound-eastwest-dualhop"` | no |
